...
public class PlaylistDAO {
     ...
     * 新建无重名的播放列表
     *
     * @param resolver Context的ContentResolver实例
     * @param name     新建的播放列表的名称
