...
public class EditTextDialogFragment extends DialogFragment {
     ...
     *
     * @param title   对话框的标题
     * @param content 文本输入框预置内容
     * @param hint    文本输入框提示信息
     * @param listner OnMyDialogInputListener实例，以接受输入事件的变化
     */
     ...
     *
     * @param isShown true表示点击按钮时对话框不会关闭，false为点击按钮对话框会关闭
     */
